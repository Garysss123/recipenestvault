...
import { indianIllustrationSets } from "./indian-illustration-sets.mjs";
import { vietnameseIllustrationSets } from "./vietnamese-illustration-sets.mjs";
import { frenchIllustrationSets } from "./french-illustration-sets.mjs";
import { italianIllustrationSets } from "./italian-illustration-sets.mjs";
import { spanishIllustrationSets } from "./spanish-illustration-sets.mjs";
import { britishIllustrationSets } from "./british-illustration-sets.mjs";
import { germanIllustrationSets } from "./german-illustration-sets.mjs";
...
import { canadianIllustrationSets } from "./canadian-illustration-sets.mjs";
import { middleEasternIllustrationSets } from "./middle-eastern-illustration-sets.mjs";
import { mediterraneanIllustrationSets } from "./mediterranean-illustration-sets.mjs";
import { africanIllustrationSets } from "./african-illustration-sets.mjs";
import { otherWorldIllustrationSets } from "./other-world-illustration-sets.mjs";
...
export const recipeStepIllustrations = [
  ...
  ...[...generatedSets, ...japaneseIllustrationSetsA, ...japaneseIllustrationSetsB, ...japaneseIllustrationSetsC, ...japaneseIllustrationSetsRamen, ...japaneseIllustrationSetsNikujaga, ...koreanIllustrationSets, ...thaiIllustrationSets, ...taiwaneseIllustrationSets, ...indianIllustrationSets, ...vietnameseIllustrationSets, ...frenchIllustrationSets, ...italianIllustrationSets, ...spanishIllustrationSets, ...britishIllustrationSets, ...germanIllustrationSets, ...greekIllustrationSets, ...americanIllustrationSets, ...mexicanIllustrationSets, ...brazilianIllustrationSets, ...canadianIllustrationSets, ...middleEasternIllustrationSets, ...mediterraneanIllustrationSets, ...africanIllustrationSets, ...otherWorldIllustrationSets].map(normalizeSet).flatMap(buildSet)
];
