    ...
    about: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: ["The first phase includes 21 cuisine guides and approved Chinese, Japanese, and Korean recipe collections in five languages. A complete recipe is published only after its method, measurements, context, sources, and matching real photograph pass review."],
    ...
    about: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: ["第一階段包含 21 個料理指南，以及通過審核的中華、日本與韓國料理食譜，並同步提供五種語言。完整食譜只有在做法、份量、背景、來源與相符的真實照片都通過審查後才會發布。"],
    ...
    about: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: ["第1段階では、21の料理ガイドと、審査を通過した中華・日本・韓国料理のレシピ集を5言語で公開します。作り方、分量、背景、出典、内容に合う実写写真をすべて確認できたレシピだけを追加します。"],
  ...
  ko: {
    about: {
      ...
      sections: [
        ...
        { id: "collection", title: "컬렉션을 확장하는 방식", paragraphs: ["첫 단계에서는 21개의 요리 가이드와 심사를 통과한 중화요리, 일본요리, 한식 레시피 컬렉션을 다섯 언어로 제공합니다. 조리법, 계량, 배경, 출처, 내용과 일치하는 실제 사진을 모두 확인한 레시피만 공개합니다."], bullets: ["긴 서문보다 실용 정보를 우선", "신뢰할 수 있는 여러 출처를 교차 확인", "계량, 시간, 용어를 일관되게 정리", "이미지 크레딧과 중요한 참고 자료를 명확히 표시"] },
