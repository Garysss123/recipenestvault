...
const record = JSON.parse(await readFile(join(root, 'docs', 'illustration-prompts', 'spanish-prompts.json'), 'utf8'));
const entries = record.entries;
const outputDir = join(root, 'qa-artifacts', 'spanish-review');
...
const output = join(outputDir, 'spanish-source-sheets-contact-sheet.jpg');
