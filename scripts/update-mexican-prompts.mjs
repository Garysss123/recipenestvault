...
const file = new URL('../docs/illustration-prompts/mexican-prompts.json', import.meta.url);
...
for (const recipe of mexicanRecipeDrafts) {
...
console.log(`Mexican prompts: ${record.entries.length} source sheets, ${record.entries.reduce((n, entry) => n + entry.usedPanels, 0)} planned step images.`);
