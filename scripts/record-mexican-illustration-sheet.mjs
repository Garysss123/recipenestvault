...
if (!recipeId || !generatedPath) throw new Error('Usage: node scripts/record-mexican-illustration-sheet.mjs <recipe-id> <generated-image-path>');
...
if (!entry) throw new Error(`${recipeId}: unknown Mexican prompt entry`);
...
const sheetDir = join(root, 'assets', 'recipes', 'illustration-sheets-generated', 'mexican');
