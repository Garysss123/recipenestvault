...
const record = JSON.parse(await readFile(join(root, 'docs', 'illustration-prompts', 'american-prompts.json'), 'utf8'));
const entries = record.entries;
const outputDir = join(root, 'qa-artifacts', 'american-review');
...
const output = join(outputDir, 'american-source-sheets-contact-sheet.jpg');
