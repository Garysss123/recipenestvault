...
const dir = join(root, 'assets/recipes/alternatives/french');
await mkdir(dir, {recursive:true});
const [command, id, ...words] = process.argv.slice(2);
const headers = {'User-Agent':'RecipeNestVault/0.1 (French licensed photo research; recipenestvault.com)'};
...
} else throw new Error('Usage: research-french-photos.mjs search|download id query|File:title');
