...
const file = new URL('../docs/illustration-prompts/british-prompts.json', import.meta.url);
...
for (const recipe of britishRecipeDrafts) {
...
console.log(`British prompts: ${record.entries.length} source sheets, ${record.entries.reduce((n, entry) => n + entry.usedPanels, 0)} planned step images.`);
