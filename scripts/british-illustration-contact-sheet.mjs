...
const record = JSON.parse(await readFile(join(root, 'docs', 'illustration-prompts', 'british-prompts.json'), 'utf8'));
const entries = record.entries;
const outputDir = join(root, 'qa-artifacts', 'british-review');
...
const output = join(outputDir, 'british-source-sheets-contact-sheet.jpg');
