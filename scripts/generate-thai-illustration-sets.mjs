...
const output = join(root, "src", "thai-illustration-sets.mjs");
const expectedDimensions = { width: 1672, height: 941 };
const sets = [];

for (const recipe of thaiRecipeDrafts) {
...
const source = `// Generated from reviewed Thai cooking-step source PNGs.\n// Run npm run manifest:thai-illustrations after an approved source image changes.\nexport const thaiIllustrationSets = ${JSON.stringify(sets, null, 2)};\n\nexport default thaiIllustrationSets;\n`;
