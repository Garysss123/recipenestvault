...
const records=JSON.parse(await readFile(join(root,'docs/research/italian-recipe-sources.json'),'utf8'));
...
const output=join(root,'qa-artifacts/italian-review/sources');await mkdir(output,{recursive:true});
