...
const record = JSON.parse(await readFile(join(root, 'docs', 'illustration-prompts', 'french-prompts.json'), 'utf8'));
const entries = record.entries;
const outputDir = join(root, 'qa-artifacts', 'french-review');
...
const output = join(outputDir, 'french-source-sheets-contact-sheet.jpg');
