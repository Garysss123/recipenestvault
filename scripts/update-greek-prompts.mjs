...
const file = new URL('../docs/illustration-prompts/greek-prompts.json', import.meta.url);
...
for (const recipe of greekRecipeDrafts) {
...
console.log(`Greek prompts: ${record.entries.length} source sheets, ${record.entries.reduce((n, entry) => n + entry.usedPanels, 0)} planned step images.`);
