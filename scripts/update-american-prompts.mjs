...
const file = new URL('../docs/illustration-prompts/american-prompts.json', import.meta.url);
...
for (const recipe of americanRecipeDrafts) {
...
console.log(`American prompts: ${record.entries.length} source sheets, ${record.entries.reduce((n, entry) => n + entry.usedPanels, 0)} planned step images.`);
