...
import { mexicanPhotoCandidates as photos } from "../src/mexican-photos.mjs";
...
const outputDirectory = join(root, "qa-artifacts", "mexican-review");
await mkdir(outputDirectory, { recursive: true });
const output = join(outputDirectory, "mexican-finished-photo-contact-sheet.jpg");
