...
const record = JSON.parse(await readFile(join(root, 'docs', 'illustration-prompts', 'mexican-prompts.json'), 'utf8'));
const entries = record.entries;
const outputDir = join(root, 'qa-artifacts', 'mexican-review');
...
const output = join(outputDir, 'mexican-source-sheets-contact-sheet.jpg');
