...
const record = JSON.parse(await readFile(join(root, 'docs', 'illustration-prompts', 'italian-prompts.json'), 'utf8'));
const entries = record.entries;
const outputDir = join(root, 'qa-artifacts', 'italian-review');
...
const output = join(outputDir, 'italian-source-sheets-contact-sheet.jpg');
