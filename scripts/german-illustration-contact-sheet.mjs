...
const record = JSON.parse(await readFile(join(root, 'docs', 'illustration-prompts', 'german-prompts.json'), 'utf8'));
const entries = record.entries;
const outputDir = join(root, 'qa-artifacts', 'german-review');
...
const output = join(outputDir, 'german-source-sheets-contact-sheet.jpg');
