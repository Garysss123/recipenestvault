...
Spanish illustration pipeline is now active. Batches A-D have 16/16 visually reviewed source sheets and 94/94 cropped step images recorded in `src/spanish-illustration-sets.mjs`. Scene-only prompt corrections keep generated artwork static and hand-free: Gazpacho uses a completed emulsion instead of a pouring stream; Croquetas hides thermometer digits; Fideuà places seared prawns at rest; Cocido shows foam and skimmer at rest; Fabada shows the removed onion resting beside the pot; Pulpo shows the octopus fully submerged after the three dips and uses a static oil sheen; Bacalao and Calamares hide thermometer digits; Marmitako shows the roasted-pepper puree fully incorporated. Content audit re-passed after these corrections. Overall progress is 16/20 reviewed source sheets and 94/115 generated step images. Nothing Spanish is globally published until all illustration mappings pass their gates.
